...
const ru = {
  ...
  not_supported_email_address: 'Неподдерживаемый имейл адрес',
  not_valid: 'Недействительно',
  not_valid_email: 'Недействительный адрес',
  ...
  tag: 'Тэг',
  tag_your_story: 'Добавьте тэги (до 5 штук), первый тэг станет основной категорией.',
  ...
  your_password_permissions_were_reduced: 'Ваши разрешения пароля были снижены',
  your_voice_is_worth_something: 'Ваша ' + VESTING_TOKEN + ' на вес золота!',
