                ...
                <p>
                    {tt(
                        showNegativeComments
                            ? 'post_jsx.now_showing_comments_with_low_ratings'
                    ...
                    <div className="row">
                        ...
                        <div className="column">
                            <div className="Post__promo">
                                {tt(
                                    'g.next_7_strings_sinngle_block.authors_get_paid_when_people_like_you_upvote_their_post'
                                )}
                                .<br />{' '}
                                {tt(
                                    'g.next_7_strings_sinngle_block.if_you_enjoyed_what_you_read_earn_amount'
                                )}
                                <br />
                                <a
                                ...
                                >
                                    ...
                                    <span className="free-money">
                                        {tt('g.next_7_strings_sinngle_block.free_steem', {
                                            LIQUID_TOKEN,
                                        })}
                                    </span>
                                </a>
