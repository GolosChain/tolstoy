...
export default function useRegistrationApi(app) {
  ...
  router.post('/verify_code', koaBody, function*() {
    ...
    const accountSid = this.request.body.AccountSid ? this.request.body.AccountSid : '';
    ...
    console.log('-- /api/v1/confirm_provider -->', phone, confirmation_code);
  ...
  router.post('/send_code', koaBody, function*() {
    ...
    let confirmation_code = parseInt(secureRandom.randomBuffer(8).toString('hex'), 16)
      .toString(10)
