...
import { MIN_ACCOUNT_NAME_LENGTH, MAX_ACCOUNT_NAME_LENGTH } from 'src/messenger/utils/constants';
...
export default class LookupAccounts extends Component {
  ...
  render() {
    const { inputValue, hasValue } = this.state;
    ...
    return (
      <LookupAccountsWrapper>
        ...
        <IconStyled>
          {hasValue ? (
            <Icon name="cross" width="16" height="16" onClick={this.onCloseClick} />
          ) : (
