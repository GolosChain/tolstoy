    ...
    return (
      <thead>
        <tr>
          <th>
            {buy
              ? tt('market_jsx.total_DEBT_TOKEN_SHORT_CURRENCY_SIGN', { DEBT_TOKEN_SHORT })
              : tt('g.price')}
          </th>
            ...
            <li>
              ...
              >
                <span aria-hidden="true">
                  &larr; {tt(buy ? 'market_jsx.higher' : 'market_jsx.lower')}
                </span>
              </div>
            </li>
            <li>
              <div
                className={
                  ...
                  (currentIndex >= orders.length - 10 ? ' disabled' : '')
                }
                onClick={this._setBuySellPage.bind(this, true)}
                aria-label="Next"
              >
                <span aria-hidden="true">
                  {tt(buy ? 'market_jsx.lower' : 'market_jsx.higher')} &rarr;
                </span>
              </div>
            </li>
          </ul>
