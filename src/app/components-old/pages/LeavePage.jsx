...
import Button from 'src/app/components-old/elements/Button';
            ...
            <div className="leave-page" style={{ backgroundImage: 'url(images/leave-bg.svg)' }}>
                <div className="leave-page_content row medium-7 large-7">
                    <Content>
                        ...
                        <p>
                            Вы кликнули на ссылку, ведущую на внешний ресурс, и покидаете
                            блог-платформу{' '}
                            <a href="https://golos.io/" target="_blank">
                                Golos.io
                            </a>
                        ...
                        <p>
                            ...
                            не имеет никакого отношения к сайту, расположенному по ссылке выше, и не
                            может гарантировать вам безопасность его использования. Сайты с закрытым
                            исходным кодом могут содержать вредоносные скрипты и использовать
                            мошеннические схемы.
                        </p>
                        <p>
                            Рекомендуем вам не переходить по ссылке, если у вас нет серьезных
                            оснований доверять внешнему ресурсу. Помните, что активный ключ вашего
                            аккаунта на{' '}
                            <a href="https://golos.io/" target="_blank">
                                Golos.io
                            </a>{' '}
