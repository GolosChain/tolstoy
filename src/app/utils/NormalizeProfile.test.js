...
describe('normalizeProfile', () => {
  ...
  it('should return a profile object with profile_image and cover_image', () => {
    const account = {
      json_metadata:
        '{"profile":{"profile_image":"https://golos.io/profile_image.jpeg","cover_image":"https://golos.io/cover_image.jpeg"}}',
    };
    ...
    assert.deepEqual(normalizeProfile(account), {
      name,
      about,
      location,
      website,
  ...
  it('should return full profile object', () => {
    const account = {
      json_metadata:
        '{"profile":{"name": "lyke", "about": "some info", "location": "NY", "profile_image":"https://golos.io/profile_image.jpeg","cover_image":"https://golos.io/cover_image.jpeg", "website":"https://lyke.me"}}',
    };
  ...
  it('should truncate fields', () => {
    const json_metadataObj = {
      profile: {
        ...
        //length 104
        website:
          'qwertyuiopqwertyuiopqwertyuiopqwertyuiopqwertyuiopqwertyuiopqwertyuiopqwertyuiopqwertyuiopqwertyuiopqwe',
      },
    };
