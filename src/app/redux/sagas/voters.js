...
import { GET_VOTERS_USERS_REQUEST, GET_VOTERS_USERS_ERROR } from 'src/app/redux/constants/voters';
...
function* getVotersWorker({ payload: { postLink, limit } }) {
    ...
    try {
        const voters = yield call([api, api.getActiveVotes], author, permlink, limit);
