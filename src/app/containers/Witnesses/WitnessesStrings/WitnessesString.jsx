  ...
  render() {
    ...
    if (thread) {
      if (links.local.test(thread)) {
        witness_thread = <PostLink to={thread}>{tt('witnesses_jsx.witness_thread')}</PostLink>;
      } else {
        witness_thread = (
    ...
    return (
      <Fragment>
        ...
        >
          ...
          <VoteButtonCeil>
            <VoteButton
              ...
              upvoted={myVote ? 1 : 0}
            >
              <Icon name={myVote ? 'white-oppos-witness' : 'witness-logo'} size="16" />
            </VoteButton>
          </VoteButtonCeil>
        ...
        <FullInfo collapsed={stringCollapsed}>
          ...
          <InfoString>
            <InfoStringSpan>{tt('witnesses_jsx.account_creation_fee')}:&nbsp;</InfoStringSpan>
            {props.get('account_creation_fee')}
          </InfoString>
          <InfoString>
            <InfoStringSpan>{tt('witnesses_jsx.maximum_block_size')}:&nbsp;</InfoStringSpan>
            {props.get('maximum_block_size')}
          </InfoString>
          <InfoString>
            <InfoStringSpan>{tt('witnesses_jsx.sbg_interest_rate')}:&nbsp;</InfoStringSpan>
            {props.get('sbd_interest_rate') / 100}%
          </InfoString>
          <InfoString>
            <InfoStringSpan>{tt('witnesses_jsx.auction_window_size')}:&nbsp;</InfoStringSpan>
          ...
          <InfoString>
            <InfoStringSpan>{tt('witnesses_jsx.max_referral_interest_rate')}:&nbsp;</InfoStringSpan>
            {props.get('max_referral_interest_rate')}
          </InfoString>
          <InfoString>
            <InfoStringSpan>{tt('witnesses_jsx.max_referral_term_sec')}:&nbsp;</InfoStringSpan>
            {props.get('max_referral_term_sec')}
          </InfoString>
          <InfoString>
            <InfoStringSpan>{tt('witnesses_jsx.min_referral_break_fee')}:&nbsp;</InfoStringSpan>
            {props.get('min_referral_break_fee')}
          </InfoString>
          <InfoString>
            <InfoStringSpan>{tt('witnesses_jsx.max_referral_break_fee')}:&nbsp;</InfoStringSpan>
          ...
          <InfoString>
            <InfoStringSpan>{tt('witnesses_jsx.comments_window')}:&nbsp;</InfoStringSpan>
            {props.get('comments_window')}
          </InfoString>
          <InfoString>
            <InfoStringSpan>{tt('witnesses_jsx.comments_per_window')}:&nbsp;</InfoStringSpan>
          ...
          <InfoString>
            <InfoStringSpan>{tt('witnesses_jsx.votes_per_window')}:&nbsp;</InfoStringSpan>
          ...
          <InfoString>
            <InfoStringSpan>{tt('witnesses_jsx.min_curation_percent')}:&nbsp;</InfoStringSpan>
            {props.get('min_curation_percent') / 100}%
          </InfoString>
          <InfoString>
            <InfoStringSpan>{tt('witnesses_jsx.max_curation_percent')}:&nbsp;</InfoStringSpan>
            {props.get('max_curation_percent') / 100}%
          </InfoString>
          <InfoString>
            <InfoStringSpan>{tt('witnesses_jsx.curation_reward_curve')}:&nbsp;</InfoStringSpan>
